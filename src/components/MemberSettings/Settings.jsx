...
const Settings = () => {
  ...
  // Only Profile (which now includes Account) remains
  const sections = [
    ...
    try {
      ...
      setProfile({
        ...
        avatar:
          ...
          )}&background=A6F13B&color=05070A&size=128`,
      });
    } catch (err) {
  ...
  /* ============================================================
     MANAGE BILLING → navigate to Payments page
     ============================================================ */
  ...
  const handleExportData = () => {
    showToast('Data export started — check your email shortly.');
  };

  /* ============================================================
     PROFILE + ACCOUNT SECTION (merged)
     ============================================================ */
  const renderProfileSection = () => (
    <div className={styles.sectionContent}>
        ...
        <div className={styles.avatarSection}>
          ...
          <div>
            ...
            <p className={styles.profileMeta}>
              {profile.membershipType} Member • Joined{' '}
      ...
      <div className={styles.sectionDivider}>
        <h3 className={styles.sectionDividerTitle}>Account</h3>
        <p className={styles.sectionDividerSubtitle}>
          Manage billing, security, and your account status
        </p>
      </div>

      {/* -------- Account Grid -------- */}
      <div className={styles.accountGrid}>
        {/* Billing — now navigates to /payments */}
        ...
        <div className={styles.accountCard}>
          <div className={styles.accountCardHeader}>
            <ShieldCheck size={20} />
            <h3 className={styles.accountCardTitle}>Security</h3>
          </div>
          <p className={styles.accountCardDesc}>
            Update your password and manage sign-in
          </p>
        ...
        <div className={styles.accountCard}>
          ...
          <p className={styles.accountCardDesc}>
            Deactivate your account temporarily. You can reactivate anytime.
          </p>
          <button
            className={`${styles.accountAction} ${styles.accountActionDanger}`}
      ...
      <div className={styles.pageHeader}>
        <div>
          ...
          <p className={styles.pageSubtitle}>
            Manage your profile, account, and privacy
          </p>
        </div>
      </div>
            ...
            <div className={styles.modalBody}>
              <div className={styles.deleteWarning}>
                ...
                <p className={styles.deleteText}>
                  ...
                  can be reversed. Your profile will be hidden and you won't be
                  able to access your account until you reactivate it. Your data
                  including workout history, progress, and membership
                ...
                <div className={styles.deleteConfirm}>
                  <label className={styles.checkboxLabel}>
                    ...
                    />
                    <span>
                      I understand my account will be temporarily deactivated
                    </span>
                  </label>
                </div>
          ...
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.modalBody}>
              <div className={styles.deleteWarning}>
                ...
                <p className={styles.deleteText}>
                  ...
                  cannot be undone. All your data, including workout history,
                  progress, and membership information, will be permanently
                  removed.
                </p>
            ...
            <div className={styles.modalFooter}>
              ...
              <button
                ...
                disabled={
                  isLoading || !deleteConfirm.checked || !deleteConfirm.password
                }
              >
